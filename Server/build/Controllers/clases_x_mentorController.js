...
var ClaseXMentorController = /** @class */ (function () {
    function ClaseXMentorController() {
    }
    ClaseXMentorController.prototype.getAll = function (req, res) {
    ...
    ClaseXMentorController.prototype.get = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ClaseXMentorController.prototype.post = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ClaseXMentorController.prototype["delete"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ClaseXMentorController.prototype.getClaseForMentor = function (mentor_id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ClaseXMentorController.prototype.getMentorForClase = function (clase_id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return ClaseXMentorController;
}());
exports["default"] = new ClaseXMentorController();
